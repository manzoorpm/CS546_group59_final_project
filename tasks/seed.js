...
async function main() {
  ...
  try{
    ...
    user2 = await userData.createUser("mm@gmail.com","9765431092","Manzoor","Mehaboob","24","Male","Hoboken","New Jersey","Manz%90");
  ...
  try{
    res1 = await restaurantData.createRestaurant("Papa Johns","5538741204","Pizza","338 Palisade Avenue","Jersey City","New Jersey","07307","38.213990","-85.531390","0800","2000",{"2":4,"4":6});
    res2 = await restaurantData.createRestaurant("Club A Steakhouse","5538741236","Steakhouse","28th Street","New York City","New York","17307","40.427818","-3.850970","1100","2200",{'2':6,'4':3});
    res3 = await restaurantData.createRestaurant("Renatos","8538741356","Pizza","338 Central Avenue","Jersey City","New Jersey","07307","37.213990","-95.531390","1000","2100",{'2':8,'4':4,'6':2});
    res4 = await restaurantData.createRestaurant("Club B Steakhouse","5538748233","Steakhouse","34th Street","New York City","New York","17308","43.427818","-8.850970","1200","2300",{'2':4,'4':3,'8':1});
    res5 = await restaurantData.createRestaurant("Artichokes","7538741208","Pizza","100 Washington Street","Hoboken","New Jersey","17309","58.213990","-105.531390","0900","0000",{'4':4,'6':2});
  ...
  try{
    reserv1 = await reservationData.createReservation((user1._id).toString(),(res1._id).toString(),"2000","5th May 2002","6");
    reserv2 = await reservationData.createReservation((user1._id).toString(),(res2._id).toString(),"2100","10th Sep 1999","8");
    reserv3 = await reservationData.createReservation((user2._id).toString(),(res1._id).toString(),"2200","8th Mar 2012","10");
    reserv4 = await reservationData.createReservation((user1._id).toString(),(res2._id).toString(),"1400","5th May 2020","7");
    reserv5 = await reservationData.createReservation((user2._id).toString(),(res5._id).toString(),"1200","25th May 2022","10");
  ...
  try{
    rev1 = await reviewData.createReview((user1._id).toString(),(res1._id).toString(),"FirstReview","Good","4.2");
    rev2 = await reviewData.createReview((user1._id).toString(),(res1._id).toString(),"SecondReview","Bad","1.8");
    rev3 = await reviewData.createReview((user2._id).toString(),(res2._id).toString(),"MyFirstReview","Okay","2.5");
    rev4 = await reviewData.createReview((user3._id).toString(),(res1._id).toString(),"ReviewforFirstTime","Decent","3");
    rev5 = await reviewData.createReview((user2._id).toString(),(res4._id).toString(),"MySecondReview","Amazing","4.5");
